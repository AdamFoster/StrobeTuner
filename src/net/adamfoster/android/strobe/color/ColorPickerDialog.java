...
package net.adamfoster.android.strobe.color;

import net.adamfoster.android.strobe.R;
import net.adamfoster.android.strobe.color.views.ColorPanelView;
import net.adamfoster.android.strobe.color.views.ColorPickerView;
		...
		ColorPickerView.OnColorChangedListener, OnClickListener 
{
	...
	private void setUp(int color) {
		...
		((Button) layout.findViewById(R.id.color_ok)).setOnClickListener(this);
		((Button) layout.findViewById(R.id.color_cancel)).setOnClickListener(this);
	}
	...
	public void onClick(View view) {
		switch (view.getId())
		{
			case R.id.color_cancel:
				onColorChanged(mOldColor.getColor());
				cancel();
				break;
			case R.id.color_ok:
				cancel();
